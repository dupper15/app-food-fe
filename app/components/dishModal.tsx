        ...
        <ScrollView
          ...
          <View className='w-full flex flex-col gap-3'>
            <View className='w-full flex flex-col gap-3'>
              ...
              <View className='flex-col justify-between items-start gap-2'>
                <Text className='font-semibold text-base'>Available</Text>
                <View className='flex-row gap-4'>
                  <TouchableOpacity
                    className={`px-4 py-2 rounded-lg border ${
                      isAvailable === true ? "bg-[#389C9A]" : "bg-white"
                    }`}
                    onPress={() => setIsAvailable(true)}>
                    <Text
                      className={
                        isAvailable === true ? "text-white" : "text-black"
                      }>
                      True
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    className={`px-4 py-2 rounded-lg border ${
                      isAvailable === false ? "bg-[#389C9A]" : "bg-white"
                    }`}
                    onPress={() => setIsAvailable(false)}>
                    <Text
                      className={
                        isAvailable === false ? "text-white" : "text-black"
                      }>
                      False
                    </Text>
                  </TouchableOpacity>
